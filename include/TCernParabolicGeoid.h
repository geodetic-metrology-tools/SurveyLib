...
public:
	...
	//@{
		...
		*/
		...
		//TCernParabolicGeoid( const string& name, const double a, const double b, const double ths);
...
private:
	...
	static const double scaleFactorM;
	...
	double  fB;
	double  fThs;
	double  costhc, cosazp, sinthc, sinazp;
