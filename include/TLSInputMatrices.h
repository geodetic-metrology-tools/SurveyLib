...
//		virtual void				setS0APrioriScaleFactor(quad scalefac);
		...
		virtual bool				setFirstDgnMtrxElement(MatrixIndex row, MatrixIndex column, quad coefficient);
		//!Sets a coefficient of the second design matrix
		virtual bool				setSecondDgnMtrxElement(MatrixIndex row, MatrixIndex column, quad coefficient);
		...
		virtual bool				setWeightMtrxElement(MatrixIndex row, MatrixIndex column, quad coefficient);
		//!Sets a coefficient of the constraint first design matrix
		virtual bool				setCnstrFirstDgnMtrxElement(MatrixIndex row, MatrixIndex column, quad coefficient);
...
private:
	...
	list<quad>*	firstDesignMatrixTransposedValues; /*!< matrix (e x u) for the parametric part of the model */
	list<int>*		firstDesignMatrixTransposedColPtr;
	list<int>*		firstDesignMatrixTransposedRowInd;

	list<quad>*	secondDesignMatrixTransposedValues; /*!< matrix (e x o) for the conditional part of the model  */
