// TEcartHorToVerPlaneMeasurement
/*!
...
class	TEcartHorToVerPlaneMeasurement : public TAPlaneMeasurement{
...
public :
	...
	//@{
		...
		TEcartHorToVerPlaneMeasurement(string targetName, TLength obsDist, TLength sigma);
	
		/*! Copy constructor */
		TEcartHorToVerPlaneMeasurement(const TEcartHorToVerPlaneMeasurement &source);
	...
	//@{
		...
		TEcartHorToVerPlaneMeasurement&	operator=(const TEcartHorToVerPlaneMeasurement& source);
