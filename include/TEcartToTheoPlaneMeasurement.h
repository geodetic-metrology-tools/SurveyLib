...
class	TEcartToTheoPlaneMeasurement : public TAPlaneMeasurement{
...
public :
	...
	//@{
		...
		TEcartToTheoPlaneMeasurement(string targetName, TLength obsDist, TLength sigma);
	
		/*! Copy constructor */
		TEcartToTheoPlaneMeasurement(const TEcartToTheoPlaneMeasurement &source);
	...
	//@{
		...
		TEcartToTheoPlaneMeasurement&	operator=(const TEcartToTheoPlaneMeasurement& source);
