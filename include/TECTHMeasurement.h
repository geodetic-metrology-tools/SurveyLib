...
class	TECTHMeasurement : public TAPlaneMeasurement{
...
public :
	...
	//@{
		...
		TECTHMeasurement(string targetName, TLength obsDist, TLength sigma);
	
		/*! Copy constructor */
		TECTHMeasurement(const TECTHMeasurement &source);
	...
	//@{
		...
		TECTHMeasurement&	operator=(const TECTHMeasurement& source);
