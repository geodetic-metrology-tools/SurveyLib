...
//	int XMin = -10;
//	int XMax = 10;
//	apfloat* values = new apfloat[colptr[colp]];
//	rowi = 0;
...
int main()
{
	...
	TSparseMatrix* res = qwe->multiply_three_F(*qwer, *qwe->transposed());
	...
	//	{
	//		printf("decomposition doesn't work!\n");
	//	}
	...
	//	apfloat* diagg = new apfloat[cholInvFull1->rowsCount()];
	...
	//	apfloat* resAxEqb = *AInv * b;
	//	apfloat* resAxEqb1 = decomposed->solve_eqn(b);
	//	
	//	for (int i = 0; i < a; i++)
	//	{
	//		apfloat t = resAxEqb1[i] / resAxEqb[i];
