...
////////////////////////////////////////////////////////////////
	...
	// Error Message: c:\Workspace\SuSource\SurveyLib\source\SpatialObjects\mathematicalconcepts\TGeodeticCoordSys.cpp(22): error C2664: 'TAngle::TAngle(const TAngle &)' : cannot convert parameter 1 from 'real' to 'const TAngle &'
	/* Method Called:
...
bool TGeodeticCoordSys::setElt(T3DMatrix* mx, const int i, const int j, const real value)
...
real TGeodeticCoordSys::getElt(const T3DMatrix* mx, const int i, const int j) const
