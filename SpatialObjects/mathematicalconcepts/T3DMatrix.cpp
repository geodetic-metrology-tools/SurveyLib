...
void T3DMatrix::operator=(const double& value)
...
T3DMatrix T3DMatrix::operator*( const double& k)
...
bool T3DMatrix::initDiag( const double& comVal)
...
bool T3DMatrix::setElt(const int i, const int j, const double value)
{//set a element into a 3D matrix
return this->getCoordSysPtr()->setElt(this, i, j, value);
}	

double T3DMatrix::getElt(const int i, const int j) const
{//set a element into a 3D matrix
