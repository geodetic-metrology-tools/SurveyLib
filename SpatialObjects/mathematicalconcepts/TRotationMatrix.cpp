...
TRotationMatrix::TRotationMatrix(ERotationType kR, double omega, double phi, double kappa)
...
bool TRotationMatrix::setAllRotations(ERotationType kR, double &om, double &p, double &k)
...
double TRotationMatrix::getElt(const int i, const int j) const
