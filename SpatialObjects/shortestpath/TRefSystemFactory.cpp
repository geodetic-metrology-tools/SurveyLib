...
{// default constructor: build the unique instance of TRefSystemFactory
	...
	real n[15][14] = {{0.16748,0.13360,0.09381,0.05738,0.02980,0.01181,0.00240,-0.00096,-0.00140,0.00180,0.01058,0.02504,0.04444,0.06777},
	...
	real eta[15][14] = {{11.71,18.31,19.51,16.21,11.11,6.61,2.31,0.21,-0.49,-3.09,-5.79,-7.89,-9.59,-10.79},
	...
	real xsi[15][14] = {{-14.80,-17.90,-17.00,-13.60,-9.50,-6.10,-3.10,-1.70,-0.60,1.70,4.40,7.60,10.10,12.30},
	...
	real nTopo[15][14] = {{0.21922,0.16100,0.10373,0.05752,0.02649,0.00767,-0.00007,-0.00098,-0.00152,0.00108,0.01032,0.02581,0.04698,0.07243},
	...
	real etaTopo[15][24] = {{23.27,29.57,26.87,19.47,11.77,6.67,0.37,-1.13,0.47,-3.13,-6.43,-8.53,-10.23,-11.63},
	...
	real xsiTopo[15][14] = {{-27.81,-27.61,-22.01,-15.71,-10.01,-6.41,-2.01,-1.91,-1.51,1.89,4.39,7.99,10.79,13.29},
	...
	real nLEP[15][14] = {{0.19361,0.15055,0.10151,0.05838,0.02779,0.00893,0.00078,-0.00076,-0.00127,0.00145,0.01059,0.02590,0.04668,0.07147},
	...
	real etaLEP[15][14] = {{15.74,23.34,23.94,18.84,11.74,6.74,0.74,-0.76,0.14,-3.16,-6.36,-8.46,-10.16,-11.46},
	...
	real xsiLEP[15][14] = {{-18.40,-22.10,-20.10,-15.20,-9.90,-6.30,-2.10,-1.80,-1.20,1.80,4.40,8.00,10.70,12.90},
	...
	real a(0.535), b(-0.096), th(ang.getRadiansValue());
	...
	real aLEP(0.614), bLEP(-0.106), thLEP(angLEP.getRadiansValue());
