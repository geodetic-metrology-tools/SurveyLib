...
//////////////////////////////////////////////////////////////////////
TWTWVFilter *TWTWVFilter::fFilter = 0;
...
////////////////////////////////////////////
TWTWVFilter *TWTWVFilter::instance()
{
	if( fFilter == 0 )
	{
		fFilter = new TWTWVFilter();
	}
...
////////////////////////////////////////////////
void TWTWVFilter::input(TLGCTStream &iStream, TWireToWireDistMeas &WTW) const{
	...
	//possibly read the vertical distance
	if (!iStream.atEnd()){
		iStream >> obsVDist;
	}
