 ...
 *
 * Note that like the ShareablePosition, you can initialize this class with initializer lists as explained here:
 * https://en.cppreference.com/w/cpp/language/aggregate_initialization (notice the benefits of C++20, not available yet in MSVC 2017).
 * @code{cpp}
