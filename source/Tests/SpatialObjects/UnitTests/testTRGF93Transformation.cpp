...
namespace tut
{
    ...
    void object::test<4>()
    {
        ...
        ensure_equals("RGF93 CC46 X", position.getX().getMetresValue(), static_cast<TReal>(4407040.76287), static_cast<TReal>(1e-4));
        ensure_equals("RGF93 CC46 Y", position.getY().getMetresValue(), static_cast<TReal>(449723.28541), static_cast<TReal>(1e-4)); 
        ensure_equals("RGF93 CC46 Z", position.getZ().getMetresValue(), static_cast<TReal>(4573892.46194), static_cast<TReal>(1e-3));
	}
}
