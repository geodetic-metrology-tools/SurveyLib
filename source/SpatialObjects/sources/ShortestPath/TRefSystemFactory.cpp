...
{// default constructor: build the unique instance of TRefSystemFactory
	...
	TPositionVector dl(-5000, 0, 0, TCoordSysFactory::k3DCartesian),
		ur(6000, 15000, 0, TCoordSysFactory::k3DCartesian);
	

		// CG2000 h=0
	static const size_t rows = 18, cols = 14;
	TMatrix *NMatrix0 = new TMatrix(rows, cols);
	TMatrix *EtaMatrix0 = new TMatrix(rows, cols);
	TMatrix *XsiMatrix0 = new TMatrix(rows, cols);

	static const std::array<std::array<TReal, cols>, rows> n = {{
		...
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.10426),LITERAL(0.07664),LITERAL(0.05189),LITERAL(0.02895),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())},
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.11714),LITERAL(0.08513),LITERAL(0.05680),LITERAL(0.03161),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())},
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.12719),LITERAL(0.09039),LITERAL(0.05892),LITERAL(0.03247),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())}
	}};


	static const std::array<std::array<TReal, cols>, rows> eta = {{
		{LITERAL(11.71),LITERAL(18.31),LITERAL(19.51),LITERAL(16.21),LITERAL(11.11),LITERAL(6.61),LITERAL(2.31),LITERAL(0.21),-LITERAL(0.49),-LITERAL(3.09),-LITERAL(5.79),-LITERAL(7.89),-LITERAL(9.59),-LITERAL(10.79)},
	...
	static const std::array<std::array<TReal, cols>, rows> xsi = {{
		{-LITERAL(14.80),-LITERAL(17.90),-LITERAL(17.00),-LITERAL(13.60),-LITERAL(9.50),-LITERAL(6.10),-LITERAL(3.10),-LITERAL(1.70),-LITERAL(0.60),LITERAL(1.70),LITERAL(4.40),LITERAL(7.60),LITERAL(10.10),LITERAL(12.30)},
	...
	fGeoidList.push_back(pCG2000);
		...
		// CG2000 h=topo
	static const size_t rowsTopo = 18, colsTopo = 14;
	TMatrix *NMatrixTopo = new TMatrix(rowsTopo, colsTopo);
	TMatrix *EtaMatrixTopo = new TMatrix(rowsTopo, colsTopo);
	TMatrix *XsiMatrixTopo = new TMatrix(rowsTopo, colsTopo);

	static const std::array<std::array<TReal, cols>, rows> nTopo = {{
		{LITERAL(0.21922),LITERAL(0.16100),LITERAL(0.10373),LITERAL(0.05752),LITERAL(0.02649),LITERAL(0.00767),-LITERAL(0.00007),-LITERAL(0.00098),-LITERAL(0.00152),LITERAL(0.00108),LITERAL(0.01032),LITERAL(0.02581),LITERAL(0.04698),LITERAL(0.07243)},
		...
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.11317),LITERAL(0.08566),LITERAL(0.06049),LITERAL(0.03373),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())},
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.13385),LITERAL(0.09675),LITERAL(0.06514),LITERAL(0.03676),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())},
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.14840),LITERAL(0.10156),LITERAL(0.06559),LITERAL(0.03741),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())}
	}};

	static const std::array<std::array<TReal, cols>, rows> etaTopo = {{
		{LITERAL(23.27),LITERAL(29.57),LITERAL(26.87),LITERAL(19.47),LITERAL(11.77),LITERAL(6.67),LITERAL(0.37),-LITERAL(1.13),LITERAL(0.47),-LITERAL(3.13),-LITERAL(6.43),-LITERAL(8.53),-LITERAL(10.23),-LITERAL(11.63)},
	...
	static const std::array<std::array<TReal, cols>, rows> xsiTopo = {{
		{-LITERAL(27.81),-LITERAL(27.61),-LITERAL(22.01),-LITERAL(15.71),-LITERAL(10.01),-LITERAL(6.41),-LITERAL(2.01),-LITERAL(1.91),-LITERAL(1.51),LITERAL(1.89),LITERAL(4.39),LITERAL(7.99),LITERAL(10.79),LITERAL(13.29)},
	...
	static const std::array<std::array<TReal, cols>, rows> nLEP = {{
		...
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.11027),LITERAL(0.08224),LITERAL(0.05700),LITERAL(0.03156),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())},
		{LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(0.12745),LITERAL(0.09240),LITERAL(0.06184),LITERAL(0.03422),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan()),LITERAL(trnan())},
...

    {
        ...
        ////////////////////////////////////////////////////////////////
        TLV03Transformation * pTrans = new TLV03Transformation(true, true);
