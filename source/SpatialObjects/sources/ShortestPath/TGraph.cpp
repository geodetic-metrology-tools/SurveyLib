...
void	TGraph::init()
{
	...
	insert(TRefSystemFactory::getRefSystemFactory()->getTransformation(TRefSystemFactory::kTRFin2TRFout),
		   TRefSystemFactory::getRefSystemFactory()->getTransformation(TRefSystemFactory::kTRFout2TRFin));
