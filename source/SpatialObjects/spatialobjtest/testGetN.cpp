...
void main() {
	...
	double x0(-3500), y0(4500), z0(2433.660);
	double x(3000), y(2500), z(2400);
//	double x3, y3, z3;
	//char* geoid = "CG2000";
	...
	cout << transformToMLA(-3500, 4500, 2433.660, &x, &y, &z, "CG1985") << endl;
	cout << x << "  " << y << "  " << z << endl;


	cout << transformFromMLA(-3500, 4500, 2433.660, &x, &y, &z, "CG1985") << endl;
	cout << x << "  " << y << "  " << z << endl;




	cout << transformToMLA2(-3500, 4500, 2433.660, &x, &y, &z, "CG1985") << endl;
	cout << x << "  " << y << "  " << z << endl;

	cout << transformFromMLA2(-3500, 4500, 2433.660, &x, &y, &z, "CG1985") << endl;
	cout << x << "  " << y << "  " << z << endl;
	
	
	double x2(-4258.36987), y2(6987.36524), z2(2436.25896);


	cout << transformToMLA2(-3500, 4500, 2433.660, &x2, &y2, &z2, "CG1985") << endl;
	cout << x2 << "  " << y2 << "  " << z2 << endl;

	cout << transformToMLA2(-3500, 4500, 2433.660, &x0, &y0, &z0, "CG2000") << endl;
	...
	double xr, yr, hr;
	double xv1 = 1999.9999639;
	double yv1 = 3000.0141029;
	double hv1 = 550.0628652;
	...
	*stream<<xr<<" / "<<yr<<" / "<<hr<<endl;
	*stream<<"deuxieme point :"<<endl;
	*stream<<"return 1 si il n'a pas d'erreur : "<<descenteVert(xv1, yv1, hv1, 50.00, &xr, &yr, &hr)<<endl;
	*stream<<xr<<" / "<<yr<<" / "<<hr<<endl<<endl<<endl;
