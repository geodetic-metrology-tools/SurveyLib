...
JNIEXPORT jint JNICALL Java_SurveyLibJni_getCG2000N0(JNIEnv *env, jobject obj, jdouble x, jdouble y, jdouble N)
{
	//TTLength le(8.8);
	//le.getKMetresValue();
...
JNIEXPORT jint JNICALL Java_SurveyLibJni_getCG2000NMachine(JNIEnv *env, jobject obj, jdouble x, jdouble y, jdouble N)
...
JNIEXPORT jint JNICALL Java_SurveyLibJni_getCG1985N0(JNIEnv *env, jobject obj, jdouble x, jdouble y, jdouble N)
{
	// get the CCS spatial position corresponding to the double values
	TSpatialPosition spos(TRefSystemFactory::getRefSystemFactory()->getRefFrame(TRefSystemFactory::kCCS));
	TPositionVector vector(x,y,0.0, TCoordSysFactory::k3DCartesian);
...
JNIEXPORT jint JNICALL Java_jnitests_JNITest_getCG1985NMachine(JNIEnv *env, jobject obj, jdouble x, jdouble y, jdouble N)
{
	// get the CCS spatial position corresponding to the double values
	TSpatialPosition spos(TRefSystemFactory::getRefSystemFactory()->getRefFrame(TRefSystemFactory::kCCS));
	TPositionVector vector(x,y,0.0, TCoordSysFactory::k3DCartesian);
...
JNIEXPORT jint JNICALL Java_SurveyLibJni_transformToMLA(JNIEnv * env, jobject obj, jdouble x0, jdouble y0, jdouble z0, jdouble x, jdouble y, jdouble z, jchar jgeoid)
{
	char* geoid = (char*)jgeoid;
	double lim = 0.000000001;
	// test to know if the origin is in the Cern grid for geoid definition
...
JNIEXPORT jint JNICALL Java_SurveyLibJni_transformFromMLA(JNIEnv * env, jobject obj, jdouble x0, jdouble y0, jdouble z0, jdouble x, jdouble y, jdouble z, jchar jgeoid)
{
	char* geoid = (char*)jgeoid;
	double lim = 0.000000001;
	// test to know if the origin is in the Cern grid for geoid definition
  ...
  (JNIEnv * env, jobject obj)
{
	...
	cout << "function ran";
	return 0;
	//(*env).DeleteLocalRef(return (jstring)"Complete");
}
