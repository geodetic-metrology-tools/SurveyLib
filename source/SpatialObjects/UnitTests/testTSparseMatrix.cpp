...
//    void object::test<7>()
//    {
//        set_test_name("Test of multiply_by_number(TReal) method ");
//
//		TMatrix test(3,3);
//		test(0,0)=2; test(0,1)=0; test(0,2)=0;
//		test(1,0)=-1; test(1,1)=2; test(1,2)=0;
...
//    void object::test<8>()
//    {
//        set_test_name("Test ldlt_decompose_lower_triangular_returning_lower_triangular(TReal*& D) method ");
//
//		TMatrix test(3,3);
//		//test(0,0)=2; test(0,1)=0; test(0,2)=0;
//		//test(1,0)=-1; test(1,1)=2; test(1,2)=0;
...
//    void object::test<12>()
//    {
//        set_test_name("Test of invert_lower_triangular_ldlt_decomposed_returning_lower_triangular(const TReal* D) method ");
//		TMatrix test(3,3);
//		
//		test(0,0)=64; test(0,1)=0; test(0,2)=0;
//		test(1,0)=24; test(1,1)=34; test(1,2)=0;
...
//    void object::test<13>()
//    {
//        set_test_name("Test of TReal* solve_eqn(const TReal* b) const method ");
//		TMatrix test(3,3);
...
//    void object::test<14>()
//    {
//        set_test_name("Test of TReal* solve_ldlt(const TReal* D, const TReal* b) const method ");
...
//    void object::test<15>()
//    {
//        set_test_name("Test of void solve_ldlt_in_place(const TSparseMatrix* LT, const TReal* D, TReal* b, int up_to = 0) const method ");
//		TMatrix test(3,3);
//		test(0,0)=2; test(0,1)=0; test(0,2)=0;
//		test(1,0)=-1; test(1,1)=2; test(1,2)=0;
//		test(2,0)=0; test(2,1)=-1; test(2,2)=2;
...
//		TReal r = 2.0;
//										
//		TReal * inversM = simple->solve_eqn(&r);
// 
//		
//		
//		/*TMatrix expected(3,3);
...
//    void object::test<19>()
//    {
//        set_test_name("Test of TSparseMatrix* multiply_diagonal_dense(const TReal* second, int secondCols) const method ");
//		
//		TMatrix test1(3,3);
//		test1(0,0)=64; test1(0,1)=0;  test1(0,2)=0;
//		test1(1,0)=24; test1(1,1)=34; test1(1,2)=0;
...
//    void object::test<20>()
//    {
//        set_test_name("Test of TSparseMatrix* multiply_diagonal_sparse(const TReal* second, int secondCols) const method ");
//
//		TMatrix test1(3,3);
//		test1(0,0)=64; test1(0,1)=0;  test1(0,2)=0;
//		test1(1,0)=24; test1(1,1)=34; test1(1,2)=0;
...
//    void object::test<23>()
//    {
//        set_test_name("Test of TReal* multiply_returning_diagonal(const TSparseMatrix& second) const method ");
//		TMatrix test(3,3);
//		test(0,0)=64; test(0,1)=0;  test(0,2)=0;
...
//
//		TReal * result = sparse->multiply_returning_diagonal(*sparseSecond);
...
//    void object::test<28>()
//    {
//        set_test_name("Test of TReal* multiply_three_returning_diagonal(const TSparseMatrix& second, const TSparseMatrix& third) const method ");
//
//		TMatrix test(3,3);
//		test(0,0)=2; test(0,1)=0; test(0,2)=0;
//		test(1,0)=-1; test(1,1)=2; test(1,2)=0;
...
//
//		TReal * result = first->multiply_three_returning_diagonal(*second,*third);
...
//    void object::test<31>()
//    {
//        set_test_name("Test of TReal* operator *(const TReal* right) const method ");
//		TMatrix test(3,3);
...
//		TReal right[] = {2, -1, 3};
//
//		TReal * result = simple->operator*(right);
...
//    void object::test<32>()
//    {
//        set_test_name("Test of TReal* operator *(const TColumnVector& right) const method ");
//		TMatrix test(3,3);
//		test(0,0)=2; test(0,1)=0; test(0,2)=0;
//		test(1,0)=-1; test(1,1)=2; test(1,2)=0;
//		test(2,0)=0; test(2,1)=-1; test(2,2)=2;
...
//        vec(2) = 2;
//
//		TReal * result = simple->operator*(vec);
...
//    void object::test<33>()
//    {
//        set_test_name("Test of TReal operator ()(int row, int column) const method ");
//		TMatrix test(3,3);
...
//		int cc = 2;
//
//		//TReal result = simple->operator()(rr, cc);
//
//		for(int i=0; i!=simple->rowsCount(); ++i)
//            for(int j=0; j!=simple->columnsCount(); ++j)
//            {
