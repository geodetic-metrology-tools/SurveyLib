...
//! The transformation from a XYHe projection to a X0Y0He reference frame
class TXYHe2X0Y0HeTransformation : public TARefFrameTransformation
{
public:
	...
	virtual void setSourceFrame(TXYHeProjection *xyhe)
	{
		fFrom = xyhe;
		return;
	}
...
private:
	...
	virtual void setDestinationFrame(TX0Y0HeProjection *x0y0he)
	{
		fTo = x0y0he;
		return;
	}
