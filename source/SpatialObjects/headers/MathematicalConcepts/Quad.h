...
inline _Quad ceilq(_Quad _X)
{
	return (__ceilq(_X));
}
inline _Quad floorq(_Quad _X)
{
	return (__floorq(_X));
}
inline _Quad fmodq(_Quad _X, _Quad _Y)
{
	return (__fmodq(_X, _Y));
}
inline _Quad fabsq(_Quad _X)
{
	return (__fabsq(_X));
}

inline _Quad expq(_Quad _X)
{
	return (__expq(_X));
}
inline _Quad frexpq(_Quad _X, int *_Y)
{
	return (__frexpq(_X, _Y));
}
inline _Quad ldexpq(_Quad _X, int _Y)
{
	return (__ldexpq(_X, _Y));
}
inline _Quad modfq(_Quad _X, _Quad *_Y)
{
	return (__modfq(_X, _Y));
}
inline _Quad logq(_Quad _X)
{
	return (__logq(_X));
}
inline _Quad log10q(_Quad _X)
{
	return (__log10q(_X));
}

inline _Quad powq(_Quad _X, _Quad _Y)
{
	return (powq(_X, _Y));
}
inline _Quad sqrtq(_Quad _X)
{
	return (__sqrtq(_X));
}

inline _Quad cosq(_Quad _X)
{
	return (__cosq(_X));
}
inline _Quad sinq(_Quad _X)
{
	return (__sinq(_X));
}
inline _Quad tanq(_Quad _X)
{
	return (__tanq(_X));
}
inline _Quad acosq(_Quad _X)
{
	return (__acosq(_X));
}
inline _Quad asinq(_Quad _X)
{
	return (__asinq(_X));
}
inline _Quad atanq(_Quad _X)
{
	return (__atanq(_X));
}
inline _Quad atan2q(_Quad _X, _Quad _Y)
{
	return (__atan2q(_X, _Y));
}
inline _Quad coshq(_Quad _X)
{
	return (__coshq(_X));
}
inline _Quad sinhq(_Quad _X)
{
	return (__sinhq(_X));
}
inline _Quad tanhq(_Quad _X)
{
	return (__tanhq(_X));
}
