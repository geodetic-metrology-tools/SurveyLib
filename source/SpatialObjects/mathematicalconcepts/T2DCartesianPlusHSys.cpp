...
bool T2DCartesianPlusHSys::setElt(T3DMatrix* mx, const int i, const int j, const double value)
...
double T2DCartesianPlusHSys::getElt(const T3DMatrix* mx, const int i, const int j) const
