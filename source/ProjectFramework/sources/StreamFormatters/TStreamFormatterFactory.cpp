...
TAStreamFormatter *TStreamFormatterFactory::getFormatter(TADataSet* ds, TAStreamFormatter::ETextFormat format, std::string seperator)
{	// Function to obtain a pointer instance of the requested text stream formatter
	int nameWidth = std::max(ds->getPointNameWidth(), 10);
	int coordWidth = std::max(ds->getCoordPrecision()+7, 10);
	int coordWidthRes= std::max(coordWidth-6, 7);
...
TAStreamFormatter *TStreamFormatterFactory::getFormatter( TAStreamFormatter::ETextFormat  format, const std::string& str)
{	// Function to obtain a pointer instance of the requested text stream formatter
	ignoring(str);
	TAStreamFormatter *formatter = 0;
...
std::string  TStreamFormatterFactory::descriptionOf( enum TAStreamFormatter::ETextFormat code )  const
...
TAStreamFormatter::ETextFormat  TStreamFormatterFactory::whichDataSet( const std::string& description )  const
