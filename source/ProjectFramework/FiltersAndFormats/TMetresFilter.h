...
#ifndef SU_METRES_FILTER
#define SU_METRES_FILTER
...
//Class definition
class TMetresFilter : public TLengthFilter //: public TObject  
{
...
protected:
	...
	//@!{
		...
		/*!Destructors*/
		virtual ~TMetresFilter();
	//@}

private:

	/*!static pointer to TMetresFilter*/
	static TMetresFilter	*fFilter;

	/*!copy constructor declaration*/
	TMetresFilter(const TMetresFilter&);
