...
#ifndef SU_KILOMETRES_FILTER
#define SU_KILOMETRES_FILTER
...
//Class definition
class TKilometresFilter : public TLengthFilter //: public TObject  
{
...
public:
	...
	//@!{
		...
		static	TKilometresFilter *instance();
...
protected:
	...
	//@!{
		...
		/*!Destructors*/
		virtual ~TKilometresFilter();
	//@}


private:

	/*!static pointer to TKilometresFilter*/
	static TKilometresFilter	*fFilter;

	/*!copy constructor declaration*/
	TKilometresFilter(const TKilometresFilter&);
	
	//ClassDef(TKilometresFilter, 1)
};

/*@}*/

#endif // SU_KILOMETRES_FILTER
