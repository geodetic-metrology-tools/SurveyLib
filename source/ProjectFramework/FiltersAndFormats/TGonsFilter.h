...
#ifndef SU_GONS_FILTER
#define SU_GONS_FILTER
...
//Class definition
class TGonsFilter : public TAngleFilter //: public TObject  
{
...
private:
	...
	static TGonsFilter	*fFilter;

	/*!copy constructor declaration*/
	TGonsFilter(const TGonsFilter&);
